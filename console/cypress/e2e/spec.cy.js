...
describe.skip('List Elements', () => {
  describe('Select List', () => {
    it('should have value', () => {
      ...
      cy.window()
        .its('form.fields.selectList.input_element.value')
        .should('deep.equal', ['option_1'])
      cy.get('#_selectList select').select('option_3')
      cy.window()
        .its('form.fields.selectList.input_element.value')
        .should('deep.equal', ['option_1', 'option_3'])
      cy.get('#_selectList select').select('option_4')
      cy.window()
        .its('form.fields.selectList.input_element.value')
        .should('deep.equal', ['option_1', 'option_3', 'option_4'])
    })
    ...
    it('can remove first value', () => {
      ...
      cy.window()
        .its('form.fields.selectList.input_element.value')
        .should('deep.equal', ['option_3', 'option_4'])
    })
    ...
    it('add an other value', () => {
      ...
      cy.window()
        .its('form.fields.selectList.input_element.value')
        .should('deep.equal', ['option_3', 'option_4', 'option_2'])
    })
    ...
    it('remove second value', () => {
      ...
      cy.window()
        .its('form.fields.selectList.input_element.value')
        .should('deep.equal', ['option_3', 'option_2'])
    })
  })
